 ...
 * 模拟大连轨道交通公交车gps数据
 */
public class KafkaBusGpsProducer {
    private static Logger logger = LoggerFactory.getLogger(KafkaBusGpsProducer.class);
    ...
    private static String TOPIC_NAME = "topic_dalian_bus_gps";

    private KafkaBusGpsProducer() {
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            fileReader = new FileReader("input/bus_gps.txt");
