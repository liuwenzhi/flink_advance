...
/**
 * 新版本处理无界数据流word count代码，按照空格拆分出每一个单词，然后统计每个单词出现次数
 ...
 * 2024年5月28日，本机加装ubuntu 20.0.4版本虚拟机，直接支持nc
 */
public class WordCountStreamUnboundedDemoNew {
    public static void main(String[] args) throws Exception {
        ...
        // 2.读取数据：socket
        DataStreamSource<String> socketDS = env.socketTextStream("192.168.190.128", 7777);
        // 基于lambda表达式实现切分和转换
